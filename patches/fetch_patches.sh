#!/usr/bin/env bash
# Download the FOUR loader-side patch files from 0xSero's repository and copy them over the SGLang tree
# (SGL=/sgl-workspace/sglang/python/sglang on the lmsysorg image). The two SM120 kernel files of his
# set are NOT needed on B200 (SM100) and are deliberately left out.
